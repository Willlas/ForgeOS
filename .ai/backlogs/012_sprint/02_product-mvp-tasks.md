...
- **Target File/Location:** `c:\Proyects\MultiAgentDev\README.md` and/or `PROJECT_STATE.md`
...
- **Target File/Location:** `c:\Proyects\MultiAgentDev\README.md`, `packages/runtime/`, `packages/cli/`
...
- **Target File/Location:** `c:\Proyects\MultiAgentDev\README.md` or `PROJECT_STATE.md`
...
- **Target File/Location:** `c:\Proyects\MultiAgentDev\PROJECT_STATE.md` and/or `ROADMAP.md`
...
- **Target File/Location:** `c:\Proyects\MultiAgentDev\PROJECT_STATE.md`, `ROADMAP.md`, `prototype/`, `experiments/`
...
- **Target File/Location:** `c:\Proyects\MultiAgentDev\README.md`, `PROJECT_STATE.md`, or `ROADMAP.md`
...
- **Action:** Review the product framing against the source epic and ensure the mission statement, MVP definition, and classification model all address the explicit acceptance criteria in [02_product-mvp.md](02_product-mvp.md).
- **Target File/Location:** `c:\Proyects\MultiAgentDev\.ai\backlogs\012_sprint\02_product-mvp.md`
